...
{
    public class ContactsRelatedContactEntityService : IContactCustomService<ContactsRelatedContactEntity>
    {
        private readonly IContactRepository<ContactsRelatedContactEntity> _contactRepository;
        public long LoggedInUserCompanyId;
        public long LoggedInUserId;
        private readonly IHttpContextAccessor _httpContextAccessor;
        public ContactsRelatedContactEntityService(
            IContactRepository<ContactsRelatedContactEntity> contactRepository,
            IContactRepository<ContactsRelatedContactEntity> relatedContacts,
            IMapper mapper,
        ...
        public void Delete(ContactsRelatedContactEntity entity)
        {
            try
            {
                if (entity != null)
        ...
        public ContactsRelatedContactEntity Get(long Id)
        {
            try
            {
        ...
        public IEnumerable<ContactsRelatedContactEntity> GetAll()
        {
            try
            {
        ...
        public ContactsRelatedContactEntity Insert(ContactsRelatedContactEntity entity)
        {
            try
            {
                if (entity != null)
        ...
        public void Remove(ContactsRelatedContactEntity entity)
        {
            try
            {
                if (entity != null)
        ...
        public void Update(ContactsRelatedContactEntity entity)
        {
            try
            {
                if (entity != null)
        ...
        public IQueryable<ContactsRelatedContactEntity> GetAllAsync()
        {
