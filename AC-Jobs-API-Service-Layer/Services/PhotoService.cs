...
{
    public class PhotoService : ICustomService<PhotosEntity>
    {
        ...
        public void Delete(PhotosEntity entity)
        {
            try
            {
                if (entity != null)
        ...
        public PhotosEntity Get(long Id)
        {
            try
            {
        ...
        public IEnumerable<PhotosEntity> GetAll()
        {
            try
            {
        ...
        public PhotosEntity Insert(PhotosEntity entity)
        {
            try
            {
                if (entity != null)
        ...
        public void Remove(PhotosEntity entity)
        {
            try
            {
                if (entity != null)
        ...
        public void Update(PhotosEntity entity)
        {
            try
            {
                if (entity != null)
        ...
        public IEnumerable<PhotosEntity> GetAllForJob(long jobId)
        {
            try
            {
                var listRepo = _attachmentRepository.GetAllAsync();
        ...
        public IQueryable<PhotosEntity> GetAllAsync()
        {
