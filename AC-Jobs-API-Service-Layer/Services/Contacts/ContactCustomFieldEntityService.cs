...
{
    public class ContactCustomFieldEntityService : IContactCustomService<ContactCustomFieldEntity>
    {
        private readonly IContactRepository<ContactCustomFieldEntity> _contactRepository;
        public long LoggedInUserCompanyId;
        public long LoggedInUserId;
        private readonly IHttpContextAccessor _httpContextAccessor;
        public ContactCustomFieldEntityService(
            IContactRepository<ContactCustomFieldEntity> contactRepository,
        ...
        public void Delete(ContactCustomFieldEntity entity)
        {
            try
            {
                if (entity != null)
        ...
        public ContactCustomFieldEntity Get(long Id)
        {
            try
            {
        ...
        public IEnumerable<ContactCustomFieldEntity> GetAll()
        {
            try
            {
        ...
        public ContactCustomFieldEntity Insert(ContactCustomFieldEntity entity)
        {
            try
            {
                if (entity != null)
        ...
        public void Remove(ContactCustomFieldEntity entity)
        {
            try
            {
                if (entity != null)
        ...
        public void Update(ContactCustomFieldEntity entity)
        {
            try
            {
                if (entity != null)
        ...
        public IQueryable<ContactCustomFieldEntity> GetAllAsync()
        {
