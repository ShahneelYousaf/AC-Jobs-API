...
{
    public class TaskContactEntityService : IContactCustomService<TaskContactEntity>
    {
        private readonly IContactRepository<TaskContactEntity> _contactRepository;
        public long LoggedInUserCompanyId;
        public long LoggedInUserId;
        private readonly IHttpContextAccessor _httpContextAccessor;
        public TaskContactEntityService(
            IContactRepository<TaskContactEntity> contactRepository,
        ...
        public void Delete(TaskContactEntity entity)
        {
            try
            {
                if (entity != null)
        ...
        public TaskContactEntity Get(long Id)
        {
            try
            {
        ...
        public IEnumerable<TaskContactEntity> GetAll()
        {
            try
            {
        ...
        public TaskContactEntity Insert(TaskContactEntity entity)
        {
            try
            {
                if (entity != null)
        ...
        public void Remove(TaskContactEntity entity)
        {
            try
            {
                if (entity != null)
        ...
        public void Update(TaskContactEntity entity)
        {
            try
            {
                if (entity != null)
        ...
        public IQueryable<TaskContactEntity> GetAllAsync()
        {
