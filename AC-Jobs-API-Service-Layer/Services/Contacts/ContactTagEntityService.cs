...
{
    public class ContactTagEntityService : IContactCustomService<ContactTagEntity>
    {
        private readonly IContactRepository<ContactTagEntity> _contactRepository;
        public long LoggedInUserCompanyId;
        public long LoggedInUserId;
        private readonly IHttpContextAccessor _httpContextAccessor;
        public ContactTagEntityService(
            IContactRepository<ContactTagEntity> contactRepository,
        ...
        public void Delete(ContactTagEntity entity)
        {
            try
            {
                if (entity != null)
        ...
        public ContactTagEntity Get(long Id)
        {
            try
            {
        ...
        public IEnumerable<ContactTagEntity> GetAll()
        {
            try
            {
        ...
        public ContactTagEntity Insert(ContactTagEntity entity)
        {
            try
            {
                if (entity != null)
        ...
        public void Remove(ContactTagEntity entity)
        {
            try
            {
                if (entity != null)
        ...
        public void Update(ContactTagEntity entity)
        {
            try
            {
                if (entity != null)
        ...
        public IQueryable<ContactTagEntity> GetAllAsync()
        {
