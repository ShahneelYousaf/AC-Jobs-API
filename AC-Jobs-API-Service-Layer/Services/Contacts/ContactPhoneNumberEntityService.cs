...
{
    public class ContactPhoneNumberEntityService : IContactCustomService<ContactPhoneNumberEntity>
    {
        private readonly IContactRepository<ContactPhoneNumberEntity> _contactRepository;
        public long LoggedInUserCompanyId;
        public long LoggedInUserId;
        private readonly IHttpContextAccessor _httpContextAccessor;
        public ContactPhoneNumberEntityService(
            IContactRepository<ContactPhoneNumberEntity> contactRepository,
            IMapper mapper,
        ...
        public void Delete(ContactPhoneNumberEntity entity)
        {
            try
            {
                if (entity != null)
        ...
        public ContactPhoneNumberEntity Get(long Id)
        {
            try
            {
        ...
        public IEnumerable<ContactPhoneNumberEntity> GetAll()
        {
            try
            {
        ...
        public ContactPhoneNumberEntity Insert(ContactPhoneNumberEntity entity)
        {
            try
            {
                if (entity != null)
        ...
        public void Remove(ContactPhoneNumberEntity entity)
        {
            try
            {
                if (entity != null)
        ...
        public void Update(ContactPhoneNumberEntity entity)
        {
            try
            {
                if (entity != null)
        ...
        public IQueryable<ContactPhoneNumberEntity> GetAllAsync()
        {
