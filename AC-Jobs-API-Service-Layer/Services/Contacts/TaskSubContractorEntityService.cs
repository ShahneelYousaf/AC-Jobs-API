...
{
    public class TaskSubContractorEntityService : IContactCustomService<TaskSubContractorEntity>
    {
        private readonly IContactRepository<TaskSubContractorEntity> _contactRepository;
        public long LoggedInUserCompanyId;
        public long LoggedInUserId;
        private readonly IHttpContextAccessor _httpContextAccessor;
        public TaskSubContractorEntityService(
            IContactRepository<TaskSubContractorEntity> contactRepository,
        ...
        public void Delete(TaskSubContractorEntity entity)
        {
            try
            {
                if (entity != null)
        ...
        public TaskSubContractorEntity Get(long Id)
        {
            try
            {
        ...
        public IEnumerable<TaskSubContractorEntity> GetAll()
        {
            try
            {
        ...
        public TaskSubContractorEntity Insert(TaskSubContractorEntity entity)
        {
            try
            {
                if (entity != null)
        ...
        public void Remove(TaskSubContractorEntity entity)
        {
            try
            {
                if (entity != null)
        ...
        public void Update(TaskSubContractorEntity entity)
        {
            try
            {
                if (entity != null)
        ...
        public IQueryable<TaskSubContractorEntity> GetAllAsync()
        {
