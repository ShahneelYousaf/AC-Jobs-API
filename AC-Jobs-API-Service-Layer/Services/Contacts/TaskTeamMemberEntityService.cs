...
{
    public class TaskTeamMemberEntityService : IContactCustomService<TaskTeamMemberEntity>
    {
        private readonly IContactRepository<TaskTeamMemberEntity> _contactRepository;
        public long LoggedInUserCompanyId;
        public long LoggedInUserId;
        private readonly IHttpContextAccessor _httpContextAccessor;
        public TaskTeamMemberEntityService(
            IContactRepository<TaskTeamMemberEntity> contactRepository,
        ...
        public void Delete(TaskTeamMemberEntity entity)
        {
            try
            {
                if (entity != null)
        ...
        public TaskTeamMemberEntity Get(long Id)
        {
            try
            {
        ...
        public IEnumerable<TaskTeamMemberEntity> GetAll()
        {
            try
            {
        ...
        public TaskTeamMemberEntity Insert(TaskTeamMemberEntity entity)
        {
            try
            {
                if (entity != null)
        ...
        public void Remove(TaskTeamMemberEntity entity)
        {
            try
            {
                if (entity != null)
        ...
        public void Update(TaskTeamMemberEntity entity)
        {
            try
            {
                if (entity != null)
        ...
        public IQueryable<TaskTeamMemberEntity> GetAllAsync()
        {
