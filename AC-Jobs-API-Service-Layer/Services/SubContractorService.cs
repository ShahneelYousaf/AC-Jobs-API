...
{
    public class SubContractorService : ICustomService<SubContractor>
    {
        private readonly IRepository<SubContractor> _statusRepository;
        private readonly IMapper _mapper;
        public long LoggedInUserCompanyId;
        public long LoggedInUserId;
        private readonly IHttpContextAccessor _httpContextAccessor;
        public SubContractorService(
             IRepository<SubContractor> statusRepository,
             IMapper mapper,
        ...
        public IEnumerable<SubContractor> GetAll()
        {
            try
            {
        ...
        public SubContractor Insert(SubContractor entity)
        {
            try
            {
                if (entity != null)
        ...
        public void Remove(SubContractor entity)
        {
            try
            {
                if (entity != null)
        ...
        public void Update(SubContractor entity)
        {
            try
            {
                if (entity != null)
        ...
        public IQueryable<SubContractor> GetAllAsync()
        {
