...
{
    public class ContactEntityService : IContactCustomService<ContactEntity>
    {
        ...
        public ContactEntity Insert(ContactEntity entity)
        {
            try
            {
                if (entity != null)
        ...
        public IQueryable<ContactEntity> GetAllAsync()
        {
